...
describe('RenderStyle param round-trip', () => {
  it('survives encode/decode unchanged', () => {
    const s: RenderStyle = {
      ...
      colorMode: 'flat', hueStart: 40, hueEnd: 300, showOverlap: false, showLabels: true, blackLine: false
    };
  ...
  it('turtle applies the requested line width, join and cap', () => {
    ...
    turtleViz.render(mk(50), {
      ...
      ...styleToParams({
        ...
        colorMode: 'flat', hueStart: 200, hueEnd: 200, showOverlap: false, showLabels: true, blackLine: false
      }),
    ...
    for (const viz of COLOURED) {
      ...
      viz.render(mk(60), {
        ...
        ...styleToParams({
          ...
          colorMode: 'none', hueStart: 0, hueEnd: 300, showOverlap: false, showLabels: true, blackLine: false
        }),
      }, ctx, { width: 300, height: 300 });
